...
namespace webdemo.Areas.Admin.Controllers
{
    ...
    {
        WebASPNetEntities objASPNETEntities = new WebASPNetEntities();
        ...
        {
            var objUser = objASPNETEntities.Users.Where(n => n.Id == Id).FirstOrDefault();
            return View(objUser);
        }
        ...
        {
            var objUser = objASPNETEntities.Users.Where(n => n.Id == objUse.Id).FirstOrDefault();
        ...
        public ActionResult Edit(User objUser)
        {
            try
            {
                var existingUser = objASPNETEntities.Users.Find(objUser.Id);
